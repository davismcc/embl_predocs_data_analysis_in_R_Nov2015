...
## What is this session? {.columns-2 .build}
...
## Linear model with a single predictor {.larger .flexbox .vcenter .build}
...
## Linear model with multiple predictors {.larger .flexbox .vcenter .build}
...
## Linear model with a design matrix {.larger .flexbox .vcenter .build}
...
## Our model for a gene {.larger .flexbox .vcenter .build}
...
## Fit simplest model for DE {.smaller}
...
## Results of the two-predictor model {.smaller}
...
## Three perspectives on PCA {.smaller .flexbox .vcenter}
...
## Mean-centre and normalise the data {.build}
...
## PCA of TCGA expression data {.smaller}
...
## Plot PCA of TCGA expression data {.smaller}
...
## TCGA expression data: PC2 vs PC3 {.smaller}
...
```{r plot-pca-tcga-3, fig.height=4, fig.width=8}
ggplot(pca_tcga_df, 
...
## TCGA expression data: PC2 vs PC4 {.smaller}

```{r plot-pca-tcga-4, fig.height=4, fig.width=8}
ggplot(pca_tcga_df, 
...
## TCGA expression data: PC5 vs PC6 {.smaller}

```{r plot-pca-tcga-5, fig.height=4, fig.width=8}
ggplot(pca_tcga_df, 
...
```{r plot-pca-tcga-6, fig.height=4, fig.width=8}
ggplot(pca_tcga_df, 
...
## What structure can you find in the data? {.flexbox .vcenter}
...
## `limma` results when fitting PCs in model {.smaller}
...
## Results from `limma` with PCs {.smaller}
